...
final class Version20231218143300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervenants (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(191) NOT NULL, telephone VARCHAR(10) NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, entreprise VARCHAR(191) DEFAULT NULL, UNIQUE INDEX UNIQ_79A002C0E7927C74 (email), UNIQUE INDEX UNIQ_79A002C0450FF010 (telephone), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lyceens (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(191) NOT NULL, telephone VARCHAR(10) NOT NULL, nom VARCHAR(191) NOT NULL, prenom VARCHAR(191) NOT NULL, âge INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
