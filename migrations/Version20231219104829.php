...
final class Version20231219104829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intervenants (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(10) NOT NULL, nom VARCHAR(255) NOT NULL, prénom VARCHAR(255) NOT NULL, salle_id INT NOT NULL, UNIQUE INDEX UNIQ_79A002C0E7927C74 (email), UNIQUE INDEX UNIQ_79A002C0450FF010 (telephone), FOREIGN KEY (salle_id) REFERENCES salles(id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
